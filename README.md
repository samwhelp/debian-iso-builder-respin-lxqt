...
# debian-iso-builder-respin-lxqt
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-respin-lxqt/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-respin-lxqt/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-respin-lxqt/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-respin-lxqt](https://github.com/samwhelp/debian-iso-builder-respin-lxqt)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-respin-lxqt.git
```


> change dir to `debian-iso-builder-respin-lxqt`

``` sh
cd debian-iso-builder-respin-lxqt
```
...
> The resulting ISO file will be placed on `debian-iso-builder-remix-lxqt/dist`
